  ...
  return (
    <section className="auth-form">
        ...
        {user ? (
            ...
            <>
                <Form {...form}>
                    {/* put autoComplete="off" to prevent auto insertion of data, also prevent hydration error */}
                    <form autoComplete="off" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8"> 
                        ...
                        {type === 'sign-up' && (
                            <>
                                ...
                                <CustomInput control={form.control} name='city' label="City" placeholder='Example: Mumbai' />
